        ...
        try {
            ...
            if (credential) {
                ...
                await transporter.sendMail({
                    ...
                    subject: 'Welcome to CaddyWizardAI!',
                    html: `
                        <html>
                        <body style="font-family: 'Open Sans', sans-serif; color: #333;">
                            ...
                            <h1 style="color: #3498DB;">Welcome to CaddyWizardAI!</h1>
                            <p>Hi ${firstName},</p>
                            <p>Thank you for joining CaddyWizardAI – your intelligent golf caddie assistant powered by PGA Tour data and AI technology.</p>
                            ...
                            <p>Once verified, you can start getting professional-level golf shot recommendations based on strokes gained analytics.</p>
                            <p>If you have any questions, our support team is here to help.</p>
                            <p>Warm regards,<br>The CaddyWizardAI Team</p>
                            </div>
                        </body>
                        </html>
          `
    ...
    app.post('/api/auth/reset-password', async (req, res) => {
        try {
            ...
            await transporter.sendMail({
                to: email,
                from: process.env.FROM_EMAIL,
                subject: 'Password Reset - CaddyWizardAI',
                html: `
          <html>
            <body style="font-family: 'Open Sans', sans-serif; color: #333;">
              <div style="max-width:600px; margin: auto; padding:20px; border:1px solid #eee; border-radius:8px; background-color:#fff;">
                ...
                <p>Hello,</p>
                <p>You have requested to reset your password for your CaddyWizardAI account. Please click the button below to proceed:</p>
        ...
        <html>
          <body style="font-family: 'Open Sans', sans-serif; background-color:#f4f4f4; color:#333;">
            <div style="max-width:600px; margin: auto; padding:20px; background-color:#fff; border-radius:8px; text-align:center;">
              ...
              <p>Start getting professional-level golf shot recommendations powered by PGA Tour data and AI.</p>
              <a href="${process.env.FRONTEND_URL}/" style="display:inline-block; padding:10px 20px; background-color:#3498DB; color:#fff; text-decoration:none; border-radius:4px;">Get Started</a>
            </div>
          </body>
        </html>
      `);
