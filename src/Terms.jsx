        ...
        <Container maxW="container.lg" py={10}>
            <VStack spacing={6} align="stretch">
                ...
                <Box>
                    ...
                    <Text mb={4}>
                        By accessing and using CaddyWizardAI, you agree to comply with these
                        Terms of Service and acknowledge that this agreement represents a legally
                        binding contract between you and CaddyWizardAI. If you do not agree with
                ...
                <Box>
                    ...
                    <Text mb={4}>
                        ...
                        (information or software) on CaddyWizardAI for personal, non-commercial
                ...
                <Box>
                    ...
                    <Text mb={4}>
                        ...
                        CaddyWizardAI does not warrant that the AI-generated outputs or insights
                ...
                <Box>
                    ...
                    <Text mb={4}>
                        CaddyWizardAI endeavors to provide accurate and reliable research
                ...
                <Box>
                    ...
                    <Text mb={4}>
                        CaddyWizardAI offers features such as automated research aggregation,
                ...
                <Box>
                    ...
                    <Text mb={4}>
                        In no event shall CaddyWizardAI or its suppliers be liable for any
                ...
                <Box>
                    ...
                    <Text mb={4}>
                        ...
                        of the jurisdiction in which CaddyWizardAI operates, without regard to
                ...
                <Box>
                    ...
                    <Text mb={4}>
                        ...
                        arbitration body. By using CaddyWizardAI, you agree to submit to such
                        arbitration.
                    </Text>
                </Box>
                ...
                <Box>
                    ...
                    <Text mb={4}>
                        ...
                        CaddyWizardAI, including text, graphics, logos, images, and software,
                        remain the property of CaddyWizardAI and are protected by international
                ...
                <Box>
                    ...
                    <Text mb={4}>
                        You agree to indemnify, defend, and hold harmless CaddyWizardAI, its
                ...
                <Box>
                    ...
                    <Text mb={4}>
                        ...
                        CaddyWizardAI, without prior notice or liability, for any reason,
